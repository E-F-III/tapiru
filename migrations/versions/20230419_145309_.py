...
Revision ID: 245544ceedad
Revises: 
Create Date: 2023-04-19 14:53:09.006798
...
def upgrade():
    ...
    op.create_table('business_payments',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('business_id', sa.Integer(), nullable=False),
    sa.Column('type_id', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['business_id'], ['businesses.id'], ),
    sa.ForeignKeyConstraint(['type_id'], ['payment_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    sa.ForeignKeyConstraint(['type_id'], ['drink_types.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    ...
    op.create_table('checkin_toppings',
    sa.Column('id', sa.Integer(), nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('checkin_toppings')
    ...
    op.drop_table('menus')
    op.drop_table('business_payments')
